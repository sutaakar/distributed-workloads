...
const (
	sftNotebookName = "sft.ipynb"
	sftNotebookPath = "resources/" + sftNotebookName
)

// Multi-GPU - Distributed Training with SFT and TrainingHubTrainer
func RunSftTrainingHubMultiGpuDistributedTraining(t *testing.T) {
	test := support.With(t)
